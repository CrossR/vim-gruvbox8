...
" Last Updated: Tue 21 Apr 00:28:44 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi Error guifg=#fb4934 guibg=#32302f guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi ErrorMsg guifg=#32302f guibg=#fb4934 guisp=NONE gui=bold cterm=bold
    ...
    hi DiffAdd guifg=#b8bb26 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi DiffChange guifg=#8ec07c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi DiffDelete guifg=#fb4934 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi DiffText guifg=#fabd2f guibg=NONE guisp=NONE gui=NONE cterm=NONE
    ...
    hi IncSearch guifg=#fe8019 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    ...
    hi Search guifg=#fabd2f guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    ...
    hi Todo guifg=fg guibg=#32302f guisp=NONE gui=bold,italic cterm=bold,italic
    ...
    hi NormalMode guifg=#a89984 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    hi InsertMode guifg=#83a598 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    hi ReplaceMode guifg=#8ec07c guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    hi VisualMode guifg=#fe8019 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    hi CommandMode guifg=#d3869b guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    hi Warnings guifg=#fe8019 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
    if has('nvim')
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi CtrlPMode2 guifg=#32302f guibg=#83a598 guisp=NONE gui=bold cterm=bold
    ...
    if get(g:, "gruvbox_filetype_hi_groups", 0)
      ...
      hi htmlBold guifg=fg guibg=#32302f guisp=NONE gui=bold cterm=bold
      hi htmlBoldUnderline guifg=fg guibg=#32302f guisp=NONE gui=bold,underline cterm=bold,underline
      hi htmlBoldItalic guifg=fg guibg=#32302f guisp=NONE gui=bold,italic cterm=bold,italic
      hi htmlBoldUnderlineItalic guifg=fg guibg=#32302f guisp=NONE gui=bold,italic,underline cterm=bold,italic,underline
      hi htmlUnderline guifg=fg guibg=#32302f guisp=NONE gui=underline cterm=underline
      hi htmlUnderlineItalic guifg=fg guibg=#32302f guisp=NONE gui=italic,underline cterm=italic,underline
      hi htmlItalic guifg=fg guibg=#32302f guisp=NONE gui=italic cterm=italic
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi Normal guifg=#3c3836 guibg=#f2e5bc guisp=NONE gui=NONE cterm=NONE
  ...
  hi Error guifg=#9d0006 guibg=#f2e5bc guisp=NONE gui=bold,reverse cterm=bold,reverse
  hi ErrorMsg guifg=#f2e5bc guibg=#9d0006 guisp=NONE gui=bold cterm=bold
  ...
  hi Cursor guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiffAdd guifg=#79740e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi DiffChange guifg=#427b58 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=#9d0006 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi DiffText guifg=#b57614 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Directory guifg=#79740e guibg=NONE guisp=NONE gui=bold cterm=bold
  hi EndOfBuffer guifg=#f2e5bc guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#af3a03 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  ...
  hi Search guifg=#b57614 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  ...
  hi Todo guifg=fg guibg=#f2e5bc guisp=NONE gui=bold,italic cterm=bold,italic
  ...
  hi NormalMode guifg=#7c6f64 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  hi InsertMode guifg=#076678 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  hi ReplaceMode guifg=#427b58 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  hi VisualMode guifg=#af3a03 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  hi CommandMode guifg=#8f3f71 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  hi Warnings guifg=#af3a03 guibg=#f2e5bc guisp=NONE gui=reverse cterm=reverse
  if has('nvim')
    hi! link TermCursor Cursor
  ...
  if get(g:, "gruvbox_plugin_hi_groups", 0)
    ...
    hi BufTabLineCurrent guifg=#f2e5bc guibg=#7c6f64 guisp=NONE gui=NONE cterm=NONE
    ...
    hi CtrlPMode2 guifg=#f2e5bc guibg=#076678 guisp=NONE gui=bold cterm=bold
  ...
  if get(g:, "gruvbox_filetype_hi_groups", 0)
    ...
    hi htmlBold guifg=fg guibg=#f2e5bc guisp=NONE gui=bold cterm=bold
    hi htmlBoldUnderline guifg=fg guibg=#f2e5bc guisp=NONE gui=bold,underline cterm=bold,underline
    hi htmlBoldItalic guifg=fg guibg=#f2e5bc guisp=NONE gui=bold,italic cterm=bold,italic
    hi htmlBoldUnderlineItalic guifg=fg guibg=#f2e5bc guisp=NONE gui=bold,italic,underline cterm=bold,italic,underline
    hi htmlUnderline guifg=fg guibg=#f2e5bc guisp=NONE gui=underline cterm=underline
    hi htmlUnderlineItalic guifg=fg guibg=#f2e5bc guisp=NONE gui=italic,underline cterm=italic,underline
    hi htmlItalic guifg=fg guibg=#f2e5bc guisp=NONE gui=italic cterm=italic
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi DiffAdd ctermfg=142 ctermbg=NONE cterm=NONE
    hi DiffChange ctermfg=107 ctermbg=NONE cterm=NONE
    hi DiffDelete ctermfg=203 ctermbg=NONE cterm=NONE
    hi DiffText ctermfg=214 ctermbg=NONE cterm=NONE
  ...
  hi Cursor ctermfg=NONE ctermbg=NONE cterm=reverse
  hi DiffAdd ctermfg=100 ctermbg=NONE cterm=NONE
  hi DiffChange ctermfg=29 ctermbg=NONE cterm=NONE
  hi DiffDelete ctermfg=124 ctermbg=NONE cterm=NONE
  hi DiffText ctermfg=172 ctermbg=NONE cterm=NONE
